...
$id = $_GET['id'];
$nhatro1 = mysqli_query($conn, "SELECT * FROM nhatro WHERE id_khuvuc = '$id' and trangthai = 1");
...
if (isset($_GET['id'])) {
    ...
    $data1 = mysqli_query($conn, "SELECT nhatro.*, COUNT(lichsu_dat.id) AS count_don FROM nhatro LEFT JOIN lichsu_dat ON nhatro.id_nhatro = lichsu_dat.id_nhatro WHERE nhatro.soluong > 0 GROUP BY nhatro.id_nhatro LIMIT $start, $limit");
    // limit vị trí bắt đầu, số lượng lấy
...
<body>
    <div class="page-body-buong">
        <style type="text/css" media="screen">
            ...
            .fillter_bl .content_fillter [class^="group-fillter fill-key-"] .attribute-title.show:after .mg-768-nhatro {
                content: "\f068";
            }
                                        ...
                                        <div class="nav-right-new nav-right-new2">
                                            <?php foreach ($tintuc as $key => $value) { ?>
                                                ...
                                                <div class="item magin-tintuc-mini">
                                                    <div class="image">
                                                        <a href="./tintuc/show_tintuc.php?id=<?php echo $value['id']; ?>"><img loading="lazy" src="./chutro/public/upload/<?php echo $value['image'] ?>">
                                                        </a>
                                                    </div>
                                                    <div class="nav-img">
                            ...
                            <div class="nav-main-content">
                                <div class="content-product magin-top-show-tro">
                                    <div class="title-primary wow fadeInUp magin-text-nhatro" style="visibility: visible; animation-name: fadeInUp;">
                                        <h1 class="title1">Khu vực <?php echo $xuatdl['tenkhuvuc']  ?></h1>
                                    </div>
                                    <div class="nav-product magin-show-nhatro" id="list-filter-ajax">
                                        <div class="row">
                                            <?php while ($xuatdl1 = mysqli_fetch_array($data1)) { ?>
                                        ...
                                        <?php if ($total > 10) { ?>
                                            ...
                                            <nav aria-label="Page navigation example">
                                                <ul class="pagination">
                                                    ...
                                                    <?php if ($cr_page - 1 > 0) { ?>
                                                        <li class="page-item"><a class="page-link" href="./khuvuc.php?id=<?php echo $xuatdl['id_khuvuc']; ?>&page=<?php echo $cr_page - 1 ?>">Trước</a>
                                                        </li>
                                                    <?php } ?>
                                                    ...
                                                    <?php for ($i = 1; $i <= $page; $i++) {
                                                        if ($i > $cr_page - 3 && $i < $cr_page + 3) { ?>
                                                            <li class="page-item <?php echo (($cr_page == $i) ? 'active' : '') ?>">
                                                                <a class="page-link" href="./khuvuc.php?id=<?php echo $xuatdl['id_khuvuc']; ?>&page=<?php echo $i ?>"><?php echo $i ?></a>
                                                            </li>
                                                    <?php }
                                                    } ?>
                                                    <?php if ($cr_page < $page) { ?>
                                                        <li class="page-item"><a class="page-link" href="./khuvuc.php?id=<?php echo $xuatdl['id_khuvuc']; ?>&page=<?php echo $cr_page + 1 ?>">Sau</a>
                                                        </li>
                                                    <?php } ?>
