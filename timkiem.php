...
// Túm tất cả cái nhà trọ có cùng id khu vực
$tintuc = mysqli_query($conn, "SELECT * FROM tintuc");
$khuvuc = mysqli_query($conn, "SELECT * FROM khuvuc");
$khuvuc1 = mysqli_query($conn, "SELECT * FROM khuvuc");

// ý nghĩa câu truy vấn trên:
// Tạo 1 cột name_cate giữa 2 thuộc tính id_cate của bảng product và id của category

if (isset($_GET['khuvuc']) && isset($_GET['gia']) && isset($_GET['loai'])) {
    $id_khuvuc = $_GET['khuvuc'];
    $gia = $_GET['gia'];
    $loai = $_GET['loai'];

    // Tách giá thành giá tối thiểu và giá tối đa
    $giaArr = explode("-", $gia);
    $minGia = $giaArr[0];
    $maxGia = $giaArr[1];

    // Truy vấn tìm kiếm nhà trọ theo giá và khu vực
    $sql = "SELECT * FROM nhatro WHERE id_khuvuc = '$id_khuvuc' AND loai = '$loai' AND price BETWEEN $minGia AND $maxGia AND soluong > 1";
    $qr = mysqli_query($conn, $sql);
}

// Bước 1: Tính tổng số dòng có cùng id_nhatro bảng nhà trọ

$total = mysqli_num_rows($qr);
$row_nhatro = mysqli_num_rows($qr); // lấy sô dòng để ktra kết quả trả về
// Bước 2: Số nhà trọ / 1 trang
...
$sql = "SELECT nhatro.*, COUNT(lichsu_dat.id) AS count_don FROM nhatro LEFT JOIN lichsu_dat ON nhatro.id_nhatro = lichsu_dat.id_nhatro WHERE id_khuvuc = '$id_khuvuc' AND loai = '$loai' AND price BETWEEN $minGia AND $maxGia AND nhatro.soluong > 0 GROUP BY nhatro.id_nhatro LIMIT $start, $limit";
$qr = mysqli_query($conn, $sql);
                                        ...
                                        <div class="search">
                                            <form action="timkiem.php" method="get" id="searchForm" class="form">
                                                <select name="khuvuc" id="" required>
                                                    ...
                                                    <?php foreach ($khuvuc
                                                        as $key => $value) { ?>
                                                        <option value="<?php echo $value['id_khuvuc'] ?>" <?php echo (($value['id_khuvuc'] == $id_khuvuc) ? 'selected' : '') ?>>
                                                ...
                                                <select name="gia" id="" required>
                                                    ...
                                                    <option value="300000-500000" <?php if (isset($_GET['gia']) && $_GET['gia'] == '300000-500000') {
                                                                                        echo 'selected';
                                                                                    } ?>>300.000đ - 500.000đ</option>
                                                    <option value="500000-700000" <?php if (isset($_GET['gia']) && $_GET['gia'] == '500000-700000') {
                                                                                        echo 'selected';
                                                                                    } ?>>500.000đ - 700.000đ</option>
                                                    <option value="700000-1000000" <?php if (isset($_GET['gia']) && $_GET['gia'] == '700000-1000000') {
                                                                                        echo 'selected';
                                                                                    } ?>>700.000đ - 1.000.000đ</option>
                                                </select>

                                                <select name="loai" id="" required>
                                                    <option value="">Loại phòng</option>
                                                    <option value="1" <?php if (isset($_GET['loai']) && $_GET['loai'] == '1') {
                                                                            echo 'selected';
                                                                        } ?>>Khép kín</option>
                                                    <option value="0" <?php if (isset($_GET['loai']) && $_GET['loai'] == '0') {
                                                                            echo 'selected';
                                                                        } ?>>Không khép kín</option>
                                                </select>
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12 col-edit-1">
                            <div class="relative-category">
                                ...
                                <div class="nav-category-home hello">
                                    <?php foreach ($khuvuc1 as $key => $value) : ?>
                                        <ul>
                                            <li>
                                        ...
                                        <div class="nav-right-new nav-right-new2">
                                            <?php foreach ($tintuc as $key => $value) { ?>
                                                ...
                                                <div class="item magin-tintuc-mini">
                                                    <div class="image">
                                                        <a href="./tintuc/show_tintuc.php?id=<?php echo $value['id'] ?>"><img src="./chutro/public/upload/<?php echo $value['image'] ?>">
                                                        </a>
                                                    </div>
                                                    <div class="nav-img">
                                                        <h3 class="title"><a href="./tintuc/show_tintuc.php?id=<?php echo $value['id'] ?>"><?php
                                                                                                                                            echo $value['tieude']
                                                                                                                                            ?></a>
                                                        </h3>
                                                    </div>
                            ...
                            <div class="nav-main-content">
                                <div class="content-product magin-top-show-tro">
                                    <div class="title-primary wow fadeInUp magin-text-nhatro" style="visibility: visible; animation-name: fadeInUp;">
                                        <h1 class="title1">
                                            <?php if ($row_nhatro > 0) {
                                                echo 'Kết quả tìm kiếm nhà trọ ';
                                            } else {
                                                echo 'Không có nhà trọ ';
                                            }
                                            ?>
                                        </h1>
                                    </div>
                                    <div class="nav-product magin-show-nhatro" id="list-filter-ajax">
                                        <div class="row">
                                            <?php while ($xuatdl1 = mysqli_fetch_array($qr)) { ?>

                                                <div class="col-md-6 col-sm-6 col-xs-12 wow fadeInUp">
                                                    <div class="item-product">
                                                        <div class="image">
                                                            <a href="<?php echo $xuatdl1['id_nhatro'] . '-nha-tro-dai-hoc-sao-do-' . makeUrl($xuatdl1['name']) . '.html' ?>" class="thubmail-img"><img loading="lazy" src="./chutro/public/upload/<?php echo $xuatdl1['image'] ?>" alt="">
                                                            </a>
                                                            <a href="<?php echo $xuatdl1['id_nhatro'] . '-nha-tro-dai-hoc-sao-do-' . makeUrl($xuatdl1['name']) . '.html' ?>" class="quick-view" data-link-action="quickview">

                                                            </a>

                                                        </div>
                                                        <div class="price-c" style="margin-left: 45px;">
                                                            <p class="price"><span class="">Phòng trống: <?php echo $xuatdl1['soluong'] ?></span>
                                                                <br><span class="gia-moi">
                                                                    Giá: <?php echo number_format($xuatdl1['price'], 0, ',', '.'); ?>
                                                                    <span class="css-size-d"> đ</span></span>
                                                            </p>


                                                        </div>
                                                        <h3 class="title padding-top-sp" style="margin-left: 45px;"><a href="<?php echo $xuatdl1['id_nhatro'] . '-nha-tro-dai-hoc-sao-do-' . makeUrl($xuatdl1['name']) . '.html' ?>">Đã thuê: <?php echo $xuatdl1['count_don'] ?></a>
                                                        </h3>
                                                        <div class="add-cart">

                                                            <a href="<?php echo $xuatdl1['id_nhatro'] . '-nha-tro-dai-hoc-sao-do-' . makeUrl($xuatdl1['name']) . '.html' ?>" class="mh " data-redirect="redirect" data-quantity="1" data-id="695" data-price="33150000">Xem
                                                                trọ</a>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <?php if ($total > 10) { ?>
                                    ...
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination">
                                            ...
                                            <?php if ($cr_page - 1 > 0) { ?>
                                                <li class="page-item"><a class="page-link" href="./timkiem.php?page=<?php echo $cr_page - 1 ?>&khuvuc=<?php echo $id_khuvuc ?>&gia=<?php echo $minGia . '-' . $maxGia ?>">Trước</a>
                                                </li>
                                            <?php } ?>
                                            ...
                                            <?php for ($i = 1; $i <= $page; $i++) {
                                                if ($i > $cr_page - 3 && $i < $cr_page + 3) { ?>
                                                    <li class="page-item <?php echo (($cr_page == $i) ? 'active' : '') ?>"><a class="page-link" href="./timkiem.php?page=<?php echo $i ?>&khuvuc=<?php echo $id_khuvuc ?>&gia=<?php echo $minGia . '-' . $maxGia ?>"><?php echo $i ?></a>
                                                    </li>
                                            <?php }
                                            } ?>
                                            <?php if ($cr_page < $page) { ?>
                                                <li class="page-item"><a class="page-link" href="./timkiem.php?page=<?php echo $cr_page + 1 ?>&khuvuc=<?php echo $id_khuvuc ?>&gia=<?php echo $minGia . '-' . $maxGia ?>">Sau</a>
                                                </li>
                                            <?php } ?>
