...
$nhatro = mysqli_query($conn, "SELECT nhatro.*, COUNT(lichsu_dat.id) AS count_don FROM nhatro LEFT JOIN lichsu_dat ON nhatro.id_nhatro = lichsu_dat.id_nhatro WHERE nhatro.soluong > 0 GROUP BY nhatro.id_nhatro LIMIT $start, $limit");
?>
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12 col-edit-1">
                            <div class="relative-category">
                                <div class="top-category">
                                    <h3 class="title-category" id="khuvuc">DANH MỤC KHU VỰC<i class="fa fa-bars"></i>
                                    </h3>
                                </div>
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12 wow fadeInUp">
                                                    <div class="item-product">
                                                        <div class="image">
                                                            ...
                                                            <a href="<?php echo $value['id_nhatro'] . '-nha-tro-dai-hoc-sao-do-' . makeUrl($value['name']) . '.html' ?>" class="quick-view" data-link-action="quickview">
                                                        ...
                                                        <div class="price-c" style="margin-left: 45px;">
                                                            <p class="price"><span class="">Phòng trống: <?php echo $value['soluong'] ?></span>
                                                                <br><span class="gia-moi">
                                                                    Giá: <?php echo number_format($value['price'], 0, ',', '.'); ?>
                                                                    <span class="css-size-d"> đ</span></span>
                                                            </p>


                                                        </div>
                                                        <h3 class="title padding-top-sp" style="margin-left: 45px;"><a href="<?php echo $value['id_nhatro'] . '-nha-tro-dai-hoc-sao-do-' . makeUrl($value['name']) . '.html' ?>">Đã thuê: <?php echo $value['count_don'] ?></a>
                                                        </h3>
                                                        <div class="add-cart">

                                                            <a href="<?php echo $value['id_nhatro'] . '-nha-tro-dai-hoc-sao-do-' . makeUrl($value['name']) . '.html' ?>" class="mh " data-redirect="redirect" data-quantity="1" data-id="695" data-price="33150000">Xem
                                                                trọ</a>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <?php if ($total > 10) { ?>
                                            ...
                                            <nav aria-label="Page navigation example">
                                                <ul class="pagination">
                                                    ...
                                                    <?php if ($cr_page - 1 > 0) { ?>
                                                        <li class="page-item"><a class="page-link" href="./nhatro.php?page=<?php echo $cr_page - 1 ?>">Trước</a>
                                                        </li>
                                                    <?php } ?>
                                                    ...
                                                    <?php for ($i = 1; $i <= $page; $i++) {
                                                        if ($i > $cr_page - 3 && $i < $cr_page + 3) { ?>
                                                            <li class="page-item <?php echo (($cr_page == $i) ? 'active' : '') ?>">
                                                                <a class="page-link" href="./nhatro.php?page=<?php echo $i ?>"><?php echo $i ?></a>
                                                            </li>
                                                    <?php }
                                                    } ?>
                                                    <?php if ($cr_page < $page) { ?>
                                                        <li class="page-item"><a class="page-link" href="./nhatro.php?page=<?php echo $cr_page + 1 ?>">Sau</a></li>
                                                    <?php } ?>
