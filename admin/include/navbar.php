    ...
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="mode_dieukhien">
            ...
            <ul class="nav">
                ...
                <li class="nav-item menu-items">
                    <a class="nav-link" href="./add_khuvuc.php">
                        <span class="menu-icon">
                            <i class="mdi mdi-laptop"></i>
                        </span>
                        <span class="menu-title">Thêm khu vực</span>
                ...
                <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch" id="">
                    ...
                    <ul class="navbar-nav w-100" id="">
                        <li class="nav-item w-100">
                            <form action="timkiem.php" method="GET" class="nav-link mt-2 mt-md-0 d-none d-lg-flex search">
