...
const mode_text_navbar_khuvuc = document.querySelector('#mode_text_navbar_khuvuc');
...
const mode_text_table_nhatro = document.querySelector('#mode_text_table_nhatro');

const mode_table_tintuc = document.querySelector('#mode_table_tintuc');
const mode_text_table_tintuc = document.querySelector('#mode_text_table_tintuc');
